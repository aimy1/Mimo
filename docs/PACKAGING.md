...
|---|---|---|---|---|
| **DEB Package** | Debian, Ubuntu, Linux Mint, Pop!_OS | `x86_64` (amd64), `aarch64` (arm64), `armv7` (armhf) | `NFPM` | `mimo_1.4.3_amd64.deb` |
| **RPM Package** | Fedora, RHEL, Rocky Linux, AlmaLinux | `x86_64`, `aarch64`, `armhfp` | `NFPM` | `mimo-1.4.3-1.x86_64.rpm` |
| **Arch Linux** | Arch Linux, Manjaro, EndeavourOS | `x86_64`, `aarch64` | `AUR (mimo-bin PKGBUILD)` | `mimo-1.4.3-x86_64.pkg.tar.zst` |
| **Universal Binary** | Any Linux Distribution | `x86_64`, `aarch64`, `armv7` | `Cargo` / `Cross` | `mimo-1.4.3-x86_64.tar.gz` |
